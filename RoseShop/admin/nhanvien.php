                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        while ($row = mysqli_fetch_array($result)) 
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="./edit_user_admin.php?id=<?= $row['id'] ?> " class="btn btn-danger" style="background: blue;">Sửa</a></td>
                                            <td><a href="./delete_admin.php?id=<?= $row['id'] ?>" class="btn btn-danger" style="background: blue;">Xóa</a></td>
                                        </tr>
                                    <?php 
                                    }
                                     ?>
