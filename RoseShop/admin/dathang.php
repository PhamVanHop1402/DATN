                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <td>
                                        <a href="./xemdonhang.php?id=<?= $row['id'] ?> " class="btn btn-danger" style="background: blue;">Xem</a>
                                    </td>
                                    <td>
                                        <a href="./edit_donhang.php?id=<?= $row['id'] ?> " class="btn btn-danger" style="background: blue;">Edit</a>
                                    </td>
                                    <td><a href="./delete_donhang.php?id=<?= $row['id'] ?> " class="btn btn-danger" style="background: blue;">Xóa</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
