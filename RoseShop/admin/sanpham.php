            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <div class="buttons">
                            <a href="./product_editing.php" style="background: blue;">Thêm sản phẩm</a>
                             </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    ?>
                                        ...
                                        <tr> 
                                            ...
                                            <td><?=$row['sltk']?></td>
                                            <td><?=$row['sldb']?></td>
                                            <td><a href="./product_editing.php?id=<?= $row['id'] ?>" class="btn btn-danger" style="background: blue;">Sửa</a></td>
                                            <td><a href="./product_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger" style="background: blue;">Xóa</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
