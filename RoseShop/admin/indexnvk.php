...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="sanphamnvk.php">Quản lý sản phẩm</a>
                                            </div>
                    ...
                    $result_order = mysqli_query($con, "SELECT count(*) as total_order from producer");
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                <a href="producernvk.php">Quản lý nhà cung cấp</a>
                                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                <a href="menu_product_nvk.php">Quản lý danh mục</a>
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                ...
                <img src="../images/banner/banner3.jpg" class="img-fluid" style="height: 600px; width: 1800px;">
         </div>
        </div>
