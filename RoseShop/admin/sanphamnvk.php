            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <div class="buttons">
                            <a href="./product_editing_nvk.php" style="background:blue;">Thêm sản phẩm</a>
                             </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    ?>
                                        ...
                                        <tr> 
                                            ...
                                            <td><?=$row['sltk']?></td>
                                            <td><?=$row['sldb']?></td>
                                            <td><a href="./product_editing_nvk.php?id=<?= $row['id'] ?>" class="btn btn-danger" style="background: blue;">Sửa</a></td>
                                            <td><a href="./product_delete_nvk.php?id=<?= $row['id'] ?>" class="btn btn-danger" style="background: blue;">Xóa</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                ...
                                <div class="col-12">
                                    <nav>
                                        ...
                                        <?php if($current_page -1 > 0) { ?>
                                            <li><a href="sanphamnvk.php?page=<?php echo $current_page -1 ?>">&laquo;</a></li>
                                            <?php } ?>
                                            <?php for($i=1; $i<=$page ;$i++) { ?>
                                                <li class="<?php echo ($current_page ==$i) ? 'active' : '' ?>"><a href="sanphamnvk.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                                              <?php  }?>
                                              
                                              <?php if($current_page +1 <= $page ) { ?>
                                            <li><a href="sanphamnvk.php?page=<?php echo $current_page +1 ?>">&raquo;</a></li>
                                            <?php } ?>
                                        </ul>
