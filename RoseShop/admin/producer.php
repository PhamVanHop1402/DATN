                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    ?>
                                        ...
                                        <tr> 
                                            ...
                                            <td><?= $row['isActive'] ?></td>
                                            <td><a href="./them_sua_producer.php?id=<?= $row['producer_id'] ?>" class="btn btn-danger" style="background: blue;">Sửa</a></td>
                                            <td><a href="./delete_producer.php?id=<?= $row['producer_id'] ?>" class="btn btn-danger" style="background: blue;">Xóa</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                ...
                                <div class="col-12">
                                    <nav>
                                        ...
                                        <?php if($current_page -1 > 0) { ?>
                                            <li><a href="producer.php?page=<?php echo $current_page -1 ?>">&laquo;</a></li>
                                            <?php } ?>
                                            <?php for($i=1; $i<=$page ;$i++) { ?>
                                                <li class="<?php echo ($current_page ==$i) ? 'active' : '' ?>"><a href="producer.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                                              <?php  }?>
                                              
                                              <?php if($current_page +1 <= $page ) { ?>
                                            <li><a href="producer.php?page=<?php echo $current_page +1 ?>">&raquo;</a></li>
                                            <?php } ?>
                                        </ul>
