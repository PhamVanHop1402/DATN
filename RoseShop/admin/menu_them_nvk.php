        ...
        <div id="content-box">
            ...
            if (isset($_GET['action']) && ($_GET['action'] == 'add' || $_GET['action'] == 'edit')) {
                ...
                <div class = "container">
                    ...
                    <a href = "menu_product_nvk.php">Quay lại danh sách danh mục</a>
                </div>
                <?php
            } 
                ?>
                    ...
                    <table>
                        ...
                        <td colspan="2">
                            <div class="form-actions">
                                ...
                                <input type="button" value="Hủy" class="cancel-button" onclick="window.location.href='menu_product_nvk.php'">
                            </div>
                        </td>
                    </tr>
                    </table>
