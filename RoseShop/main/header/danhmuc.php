...
<section class="duoinavbar" style="background-color:#005091;">
        <div class="container text-white" style="background-color:#005091;">
            <div class="row justify">
                <div class="col-lg-3 col-md-5 " >
                    <div class="categoryheader" style="background-color:#003B6B;">
